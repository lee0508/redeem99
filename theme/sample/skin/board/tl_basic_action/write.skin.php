		...
		<section id="bo_w" style="padding:10px; box-sizing:border-box">
    ...
    <?php } ?>
				...
				<div class="bo_w_tit write_div">
						...
						<div id="autosave_wrapper write_div">
								<input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="frm_input full_input required" maxlength="255" placeholder="제목" style="width:100%">
				...
				<div class="bo_w_link write_div">
						...
						<input type="text" name="wr_link<?php echo $i ?>" value="<?php if($w=="u"){echo $write['wr_link'.$i];} ?>" id="wr_link<?php echo $i ?>" class="frm_input full_input" style="width:100%">
				</div>
				<?php } ?>
