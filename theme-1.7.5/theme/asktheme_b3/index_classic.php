 ...
 * 그누보드 5.4 이상에서 짧은 주소 사용시 게시판 링크는 아래와 같이 작성하세요.
 * <?php echo ask_get_pretty_board_url('게시판테이블명');?>
 * get_pretty_url 함수를 사용해도 됩니다.
 */
?>
		...
		<ul class="sub-list sub-item">
			...
			<li class='sl-wrap sl-note'>
				<div class="sl-inner">
					...
					<a href="<?php echo ask_get_pretty_board_url('notice'); ?>" class="sl-subject flip-animate"><span data-hover="공지">공지</span>사항</a>
					<?php
			...
			<li class='sl-wrap sl-qna'>
				<div class="sl-inner qa">
					...
					<a href="<?php echo ask_get_pretty_board_url('qa'); ?>" class="sl-subject flip-animate"><span data-hover="온라인">온라인</span>문의</a>
					<p class="sl-contents">
						문의사항을 남겨주시면 빠른 시간안에 답변드리겠습니다.<br/><br/>
						<a href='<?php echo ask_get_pretty_board_url('qa'); ?>' class="btn btn-outline-info btn-sm">문의하기</a>
					</p>
			...
			<li class='sl-wrap sl-recruit'>
				<div class="sl-inner">
					...
					<a href="<?php echo ask_get_pretty_board_url('recruit'); ?>" class="sl-subject flip-animate"><span data-hover="채용">채용</span>정보</a>
					<?php
                    /*
...
<script type="text/javascript">
	$(function() {
		...
		var scene = new ScrollMagic.Scene({
			...
			.setClassToggle(".info-block", "fadeInUp_1 visible")
			.addTo(controller1);
		...
		var scene2 = new ScrollMagic.Scene({
			...
			.setClassToggle(".sub-list.sub-item", "fadeInUp_1-5 visible")
			.addTo(controller1);
		$(' .img-hover-effect > div > .card > .img-hover-item ')
			.each(function() {
				$(this)
					.hoverdir();
			});
