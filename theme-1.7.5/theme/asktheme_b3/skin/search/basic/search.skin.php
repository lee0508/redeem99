    ...
    <div id="sch_result">
        ...
        <?php if ($stx && $board_count) { ?>
            ...
            for ($idx = $table_index, $k = 0; $idx < count($search_table) && $k < $rows; $idx++) {
                ?>
                <h2 class="sub-title"><a href="<?php echo ask_get_pretty_board_url($search_table[$idx], '', $search_query); ?>"><?php echo $bo_subject[$idx] ?> 게시판 내 결과</a></h2>
                ...
                <div class="sch_more"><a href="<?php echo ask_get_pretty_board_url($search_table[$idx], '', $search_query); ?>" class="btn btn-secondary btn-sm"><?php echo $bo_subject[$idx] ?> 결과 더보기</a></div>
            <?php } ?>
            <?php if ($stx && $board_count) { ?>
            </section>
        <?php } ?>
