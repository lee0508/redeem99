				...
				<div class="col-sm-12 col-md-12 col-lg-5">
					<div class="row mb-4">
						<div class="col-sm-12 intro-head-text">
							...
							<p>
								간단한 인사말 입력하세요. Dummy text 입니다. 내용을 입력해 주세요.간단한 인사말 입력하세요. Dummy text 입니다. 내용을 입력해 주세요.내용을 입력해 주세요.간단한 인사말
								입력하세요. Dummy text 입니다. 내용을 입력해 주세요.
							</p>
						</div>
					</div>
					<div class="row">
...
<script type="text/javascript">
	$(function() {
		...
		var client_scene = new ScrollMagic.Scene({
			...
			.setClassToggle(".client-info-item", "fadeInRight visible")
			.addTo(controller1);
		...
		var scene = new ScrollMagic.Scene({
			...
			.setClassToggle(".video-carousel-item", "fadeInLeft visible")
			.addTo(controller1);
		...
		var scene3 = new ScrollMagic.Scene({
			...
			.setClassToggle(".intro-section", "fadeIn visible")
			.addTo(controller1);
		...
		var scene4 = new ScrollMagic.Scene({
			...
			.setClassToggle(".sub-info-container", "fadeInUp_1-5 visible")
			.addTo(controller1);
		...
		var scene4_1 = new ScrollMagic.Scene({
			...
			.setClassToggle(".shuffle-grid", "fadeIn visible")
			.addTo(controller1);
		...
		var scene5 = new ScrollMagic.Scene({
			...
			.setClassToggle(".banner-swiper-container", "fadeInUp_1-5 visible")
			.addTo(controller1);
